...
(function (M, a) {
	...
	(function (a) {
		...
		a.Fx.prototype = {
			dSetter: function () {
				...
				if (1 === v)
					...
					for (; l--; )
						r = parseFloat(a[l]), g[l] = isNaN(r) ? a[l] : v * parseFloat(d[l] - r) + r;
				else
					g = d;
			...
			update: function () {
				...
				if (this[d + "Setter"])
					...
					a.attr ? a.element && a.attr(d, g, null, !0) : a.style[d] = g + this.unit;
				v && v.call(a, g, this)
			},
			run: function (a, d, g) {
				var p = this,
			...
			step: function (a) {
				...
				if (g.attr && !g.element)
					...
					this.pos = p.easing((d - this.startTime) / r), this.now = this.start + (this.end - this.start) * this.pos, this.update(), g = !0;
				return g
			},
			initPath: function (a, d, g) {
				function p(a) {
					...
					e;
					for (h = a.length; h--; )
						c = "M" === a[h] || "L" === a[h], e = /[a-zA-Z]/.test(a[h + 3]), c && e && a.splice(h + 1, 0, a[h + 1], a[h + 2], a[h + 1], a[h +
								2])
				}
				function l(a, c) {
					for (; a.length < k; ) {
				...
				function r(a, c) {
					for (var b = (k - a.length) / t; 0 < b && b--; )
						e = a.slice().splice(a.length / u - t, t * u), e[0] = c[k - t - b * t], w && (e[t - 6] = e[t - 2], e[t - 5] = e[t - 1]), [].splice.apply(a, [a.length / u, 0].concat(e)), C && b--
				}
				d = d || "";
				var f,
				b = a.startX,
		...
		a.merge = function () {
			...
			l = function (d, f) {
				...
				"object" !== typeof d && (d = {});
				for (n in f)
					f.hasOwnProperty(n) && (b = f[n], a.isObject(b, !0) && "renderTo" !== n && "number" !== typeof b.nodeType ? d[n] =
							l(d[n] || {}, b) : d[n] = f[n]);
				return d
			};
		...
		a.attr = function (p, d, g) {
			...
			l;
			if (a.isString(d))
				a.defined(g) ? p.setAttribute(d, g) : p && p.getAttribute && (l = p.getAttribute(d));
			else if (a.defined(d) && a.isObject(d))
				for (v in d)
					p.setAttribute(v, d[v]);
			return l
		};
		a.splat = function (p) {
		...
		a.dateFormat = function (p, d, g) {
			...
			for (r in v)
				for (; -1 !== p.indexOf("%" + r); )
					p = p.replace("%" + r, "function" === typeof v[r] ? v[r](d) : v[r]);
		...
		a.stop = function (a, d) {
			for (var g = E.length; g--; )
				E[g].elem !== a || d && d !== E[g].prop || (E[g].stopped = !0)
		};
		...
		a.fireEvent = function (p, d, g, v) {
			...
			if (F.createEvent && (p.dispatchEvent || p.fireEvent))
				l = F.createEvent("Events"), l.initEvent(d, !0, !0), a.extend(l, g), p.dispatchEvent ? p.dispatchEvent(l) : p.fireEvent(d, l);
			else if (l)
		...
		a.animate = function (p, d, g) {
			...
			g.curAnim = a.merge(d);
			for (b in d)
				a.stop(p, b), f = new a.Fx(p, g, b), r = null, "d" === b ? (f.paths = f.initPath(p, p.d, d.d), f.toD = d.d, v = 0, r = 1) : p.attr ? v = p.attr(b) : (v = parseFloat(a.getStyle(p, b)) || 0, "opacity" !== b &&
		...
		H.jQuery && (H.jQuery.fn.highcharts = function () {
			...
			if (this[0])
				return p[0] ? (new(a[a.isString(p[0]) ? p.shift() : "Chart"])(this[0], p[0], p[1]), this) : A[a.attr(this[0], "data-highcharts-chart")]
		});
		F && !F.defaultView && (a.getStyle = function (p, d) {
			...
			[d];
			if (p.style[d])
				return a.pInt(p.style[d]);
			"opacity" === d && (d = "filter");
			if (g)
				return p.style.zoom = 1, Math.max(p[g] - 2 * a.getStyle(p, "padding"), 0);
		...
		a.Color.prototype = {
			...
			init: function (d) {
				...
				if ((this.input = d = this.names[d] || d) && d.stops)
					...
					for (l = this.parsers.length; l-- && !v; )
						r = this.parsers[l], (g = r.regex.exec(d)) && (v = r.parse(g));
				this.rgba = v || []
			},
			get: function (a) {
				var g = this.input,
			...
			brighten: function (a) {
				...
				if (this.stops)
					...
					for (d = 0; 3 > d; d++)
						v[d] += p(255 * a), 0 > v[d] && (v[d] = 0), 255 < v[d] && (v[d] = 255);
				return this
			},
	...
	(function (a) {
		...
		E.prototype = {
			...
			applyTextOutline: function (a) {
				...
				m,
				b;
				-1 !== a.indexOf("contrast") && (a = a.replace(/contrast/g, this.renderer.getContrast(y.style.fill)));
				this.fakeTS = !0;
			...
			attr: function (a, B, c, m) {
				...
				if ("string" === typeof a)
					z = (this[a + "Getter"] || this._defaultGetter).call(this, a, b);
				else {
					for (y in a)
						B = a[y], q = !1, m || N(this, y), this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(y) &&
			...
			updateShadows: function (a, B, c) {
				for (var y = this.shadows, m = y.length; m--; )
					c.call(y[m], "height" === a ? Math.max(B - (y[m].cutHeight || 0), 0) : "d" === a ? this.d : B, a, y[m])
			},
			addClass: function (a,
				B) {
				var y = this.attr("class") || "";
				-1 === y.indexOf(a) && (B || (a = (y + (y ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
				return this
			},
			hasClass: function (a) {
			...
			align: function (a, B, c) {
				...
				h;
				if (a) {
					if (this.alignOptions = a, this.alignByTranslate = B, !c || x(c))
						this.alignTo = y = c || "renderer", k(b, this), b.push(this), c = null
				} else
					a = this.alignOptions, B = this.alignByTranslate, y = this.alignTo;
				c = D(c, m[y], m);
				y = a.align;
				m = a.verticalAlign;
				b =
			...
			destroy: function () {
				...
				for (this.destroyShadows(); c && c.div && 0 === c.div.childNodes.length; )
			...
			shadow: function (a, c, m) {
				...
				if (!a)
					...
					for (B = 1; B <= q; B++)
						b = e.cloneNode(0), z = 2 * q + 1 - 2 * B, p(b, {
							isShadow: "true",
			...
			zIndexSetter: function (a, c) {
				...
				if (B) {
					...
					for (q = 0; q < c.length && !z; q++)
						y = c[q], B = y.zIndex, y !== e && (G(B) > a || !r(a) && r(B) || 0 > a && !r(B) && b !== m.box) && (b.insertBefore(e, y), z = !0);
					z || b.appendChild(e)
				}
				return z
			},
		...
		A.prototype = {
			...
			init: function (a, c, m, b, e, z) {
				...
				y = b.element;
				a.appendChild(y);
				-1 === a.innerHTML.indexOf("xmlns") && p(y, "xmlns", this.SVG_NS);
				this.isSVG = !0;
				this.box = y;
				this.boxWrapper = b;
				this.alignedObjects =
							...
							if ("" !== e || 1 === q.length) {
								...
								if (" " !== e) {
									...
									if (C) {
										...
										for (var Q = 1 < q.length || B || 1 < h.length && !G, r, I, w = [], L = P(D), S = a.rotation, O = e, R = O.length; (Q || K) && (h.length || w.length); )
											a.rotation =
			...
			button: function (a, m, b, e, z, q, h, k, x) {
				...
				B.setState = function (a) {
					1 !== a && (B.state = y = a);
					B.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-" +
			...
			text: function (a, c, b, e) {
				...
				e || (a.xSetter = function (a, c, m) {
					...
					for (q = 0; q < b.length; q++)
						e = b[q], e.getAttribute(c) === z && e.setAttribute(c, a);
					m.setAttribute(c, a)
				});
				return a
			},
		...
		a.svg || (A = {
				...
				pathToVML: function (a) {
					for (var c = a.length, b = []; c--; )
						n(a[c]) ? b[c] = Math.round(10 * a[c]) - 5 : "Z" === a[c] ? b[c] = "x" : (b[c] = a[c], !a.isArc || "wa" !== a[c] && "at" !== a[c] || (b[c + 5] === b[c + 7] && (b[c + 7] += a[c + 7] > a[c + 5] ? 1 : -1), b[c + 6] === b[c + 8] && (b[c + 8] += a[c + 8] > a[c + 6] ? 1 : -1)));
					return b.join(" ") || "x"
				},
				clip: function (a) {
					var c = this,
				...
				shadow: function (a, b, h) {
					...
					if (a) {
						...
						y = (a.opacity || .15) / t;
						for (q = 1; 3 >= q; q++)
							z = 2 * t + 1 - 2 * q, h && (l = this.cutOffPath(m.value, z + .5)), d = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"', z, '" filled\x3d"false" path\x3d"', l, '" coordsize\x3d"10 10" style\x3d"', f.style.cssText, '" /\x3e'], x = F(n.prepVML(d), null, {
									left: e(u.left) + k(a.offsetX, 1),
									top: e(u.top) + k(a.offsetY, 1)
								}), h && (x.cutOff = z + 1), d = ['\x3cstroke color\x3d"',
								a.color || "#000000", '" opacity\x3d"', y * q, '"/\x3e'], F(n.prepVML(d), null, null, x), b ? b.element.appendChild(x) : f.parentNode.insertBefore(x, f), c.push(x);
						this.shadows = c
					}
					return this
				},
				...
				color: function (c, b, e, h) {
					...
					if (u) {
						...
						if ("fill" === e)
							if ("gradient" === u)
								e = d.x1 || d[0] || 0, c = d.y1 || d[1] || 0, t = d.x2 || d[2] || 0, d = d.y2 || d[3] || 0, r = 'angle\x3d"' + (90 - 180 * Math.atan((d - c) / (t - e)) / Math.PI) + '"',
								K();
							else {
								var x = d.r,
								p = 2 * x,
						...
						f.test(c) && "IMG" !== b.tagName ? (k = a.color(c), h[e + "-opacitySetter"](k.get("a"), e, b), x = k.get("rgb")) : (x = b.getElementsByTagName(e),
	...
	(function (a) {
		...
		a.defaultOptions = {
			...
			lang: {
				...
				shortMonths: "Jan Feb Mar Apr Mai Jun Jul Aug Sep Okt Nov Dez".split(" "),
	...
	(function (a) {
		...
		a.PlotLineOrBand.prototype = {
			render: function () {
				...
				if (C)
					q = d.getPlotLinePath(e, u.strokeWidth());
				else if (h)
					q = d.getPlotBandPath(k, t, b);
				else
					return;
				if (c && q && q.length) {
					if (u.attr({
		...
		a.AxisPlotLineOrBandExtension = {
			...
			removePlotBandOrLine: function (a) {
				for (var g = this.plotLinesAndBands, f = this.options, b = this.userOptions, n = g.length; n--; )
					g[n].id === a && g[n].destroy();
				p([f.plotLines || [], b.plotLines ||
						[], f.plotBands || [], b.plotBands || []], function (b) {
					for (n = b.length; n--; )
						b[n].id === a && d(b, b[n])
				})
			}
	...
	(function (a) {
		...
		a.Tick.prototype = {
			...
			handleOverflow: function (a) {
				...
				q = {};
				if (t)
					0 > t && r - k * e < n ? c = Math.round(r / Math.cos(t * g) - n) : 0 < t && r + k * e > b && (c = Math.round((f - r) / Math.cos(t * g)));
				else if (f = r + (1 - k) * e, r - k * e < n ? C = a.x + C * (1 - k) - n : f > b && (C = b - a.x + C * k, u = -1), C = Math.min(h,
							C), C < h && "center" === l.labelAlign && (a.x += u * (h - C - k * (h - Math.min(e, C)))), e > C || l.autoRotation && (w.styles || {}).width)
					c = C;
			...
			render: function (a, g, r) {
				...
				if (!g && C && (e = f.getPlotLinePath(e + D, C.strokeWidth() * v, g, !0)))
	...
	(function (a) {
		...
		a.Axis.prototype = {
			...
			init: function (a, b) {
				...
				-1 === C(this, a.axes) && (c ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
			...
			defaultLabelFormatter: function () {
				...
				if (n)
					...
					for (; q-- && void 0 === d; )
						e = Math.pow(f, q + 1), b >= e && 0 === 10 * c % e && null !== B[q] && 0 !== c && (d = a.numberFormat(c / e, -1) + B[q]);
			...
			getSeriesExtremes: function () {
				...
				b(a.series, function (b) {
					if (b.visible ||
						...
						a.isLog && 0 >= z && (z = null);
						if (a.isXAxis)
							m = b.xData, m.length && (b = H(m), c(b) || b instanceof Date || (m = h(m, function (a) {
											return c(a)
										}), b = H(m)), a.dataMin = Math.min(I(a.dataMin, m[0]), b), a.dataMax = Math.max(I(a.dataMax, m[0]), F(m)));
						else if (b.getExtremes(), k = b.dataMax, b = b.dataMin, l(b) && l(k) && (a.dataMin = Math.min(I(a.dataMin, b), b), a.dataMax = Math.max(I(a.dataMax, k), k)), l(z) && (a.threshold = z), !m.softThreshold || a.isLog)
							a.softThreshold =
								!1
					}
				})
			...
			getMinorTickPositions: function () {
				...
				if (f && f / c < this.len / 3)
					if (this.isLog)
						...
						e = e.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c), h, k, a.startOfWeek));
					else
						for (b = h + (b[0] - h) % c; b <= k && b !== e[0]; b += c)
							e.push(b);
			...
			nameToX: function (a) {
				...
				l(e) || (e = !1 === this.options.uniqueNames ? a.series.autoIncrement() : C(a.name, c));
			...
			setAxisTranslation: function (a) {
				...
				g = c.isXAxis;
				if (g || n || m)
					h = c.getClosest(), d ? (k = d.minPointOffset, f = d.pointRangePadding) : b(c.series, function (a) {
			...
			zoom: function (a, b) {
				...
				if (a !== this.min || b !== this.max)
					this.allowZoomOutside || (l(c) && (a < h && (a = h), a > m && (a = m)), l(e) && (b < h && (b = h), b > m && (b = m))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
						trigger: "zoom"
					});
				return !0
			},
			...
			unsquish: function () {
				...
				c ? (g = !a.staggerLines && !a.step && (l(q) ? [q] : k < I(a.autoRotationLimit, 80) && a.autoRotation)) && b(g, function (a) {
					var b;
					if (a === q || a && -90 <= a && 90 >= a)
						n = t(Math.abs(d.h / Math.sin(r * a))), b = n +
			...
			renderUnsquish: function () {
				...
				if (this.autoRotation)
					C > n && C > g.h ? u.rotation = this.labelRotation : this.labelRotation = 0;
				else if (d && (D = {
							width: n + "px"
						}, !t))
					for (D.textOverflow = "clip", G = e.length; !f && G--; )
						if (l = e[G], n = h[l].label)
							n.styles && "ellipsis" === n.styles.textOverflow ? n.css({
								textOverflow: "clip"
							}) :
			...
			render: function () {
				...
				if (a.hasData() || d)
					a.minorTickInterval && !a.categories && b(a.getMinorTickPositions(), function (b) {
						t[b] || (t[b] = new N(a, b, "minor"));
						r && t[b].isNew && t[b].render(null, !0);
						t[b].render(null, !1, 1)
					}), n.length && (b(n, function (b, c) {
							if (!d || b >= a.min && b <= a.max)
								g[b] || (g[b] = new N(a, b)), r && g[b].isNew && g[b].render(c, !0, .1), g[b].render(c)
			...
			destroy: function (a) {
				...
				for (m in c)
					c.hasOwnProperty(m) && -1 === C(m, c.keepProps) && delete c[m]
			},
	...
	(function (a) {
		...
		E.prototype.getTimeTicks = function (a, r, t, k) {
			...
			if (p(r)) {
				...
				if (x >= b.second)
					c[A.hcSetSeconds](x >= b.minute ? 0 : w * Math.floor(c.getSeconds() /
							w));
				if (x >= b.minute)
					c[A.hcSetMinutes](x >= b.hour ? 0 : w * Math.floor(c[A.hcGetMinutes]() / w));
				if (x >= b.hour)
					c[A.hcSetHours](x >= b.day ? 0 : w * Math.floor(c[A.hcGetHours]() / w));
				if (x >= b.day)
					c[A.hcSetDate](x >= b.month ? 1 : w * Math.floor(c[A.hcGetDate]() / w));
				x >= b.month && (c[A.hcSetMonth](x >= b.year ? 0 : w * Math.floor(c[A.hcGetMonth]() / w)), u = c[A.hcGetFullYear]());
				if (x >= b.year)
					c[A.hcSetFullYear](u - u % w);
				if (x === b.week)
					c[A.hcSetDate](c[A.hcGetDate]() - c[A.hcGetDay]() + f(k, 1));
				u = c[A.hcGetFullYear]();
				k = c[A.hcGetMonth]();
				var v = c[A.hcGetDate](),
				D = c[A.hcGetHours]();
				if (A.hcTimezoneOffset || A.hcGetTimezoneOffset)
					I = (!n || !!A.hcGetTimezoneOffset) && (t - r > 4 * b.month || l(r) !== l(t)), c = c.getTime(), c = new A(c + l(c));
				n = c.getTime();
				for (r = 1; n < t; )
					e.push(n), n = x === b.year ? q(u + r * w, 0) : x === b.month ? q(u, k + r * w) : !I || x !== b.day && x !== b.week ? I && x === b.hour ? q(u, k, v, D + r * w) : n + x * w : q(u, k, v + r * w * (x === b.day ? 1 : 7)), r++;
				e.push(n);
			...
			if (.5 <= a)
				...
				for (var f = Math.floor(g), t, k, e, h, C, d = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < v + 1 && !C; f++)
					for (k = d.length, t = 0; t < k && !C; t++)
						e = n(b(f) * d[t]), e > g && (!l || h <= v) && void 0 !== h && w.push(h), h > v && (C = !0), h = e;
			else
				g = b(g), v =
	...
	(function (a) {
		...
		a.Tooltip.prototype = {
			...
			getPosition: function (a, f, d) {
				...
				h = d.h || 0,
				n,
				u = ["y", b.chartHeight, f, d.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight],
			...
			getXDateFormat: function (a, d, g) {
				...
				if (k) {
					...
					for (e in f) {
						...
						if (h[e] && n.substr(h[e]) !== "01-01 00:00:00.000".substr(h[e]))
							break;
						"week" !== e && (u = e)
					}
					e && (b = d[e])
	...
	(function (a) {
		...
		a.Pointer.prototype = {
			...
			runPointActions: function (e) {
				...
				if (c)
					for (l = G.length; l--; )
						(G[l].x !== G[0].x || G[l].series.noSharedTooltip) && G.splice(l, 1);
				if (G[0] && (G[0] !== this.prevKDPoint || k && k.isHidden)) {
					if (c &&
						!G[0].series.noSharedTooltip) {
						for (l = 0; l < G.length; l++)
							G[l].onMouseOver(e, G[l] !== (t && t.directTouch && n || G[0]));
				...
				d && (f = t && t.tooltipOptions.followPointer, k && f && !k.isHidden && (f = k.getAnchor([{}
								], e), k.updatePosition({
							plotX: f[0],
							plotY: f[1]
						})));
			...
			reset: function (a, b) {
				...
				if (a)
					f && d && (f.refresh(d), c && (c.setState(c.state, !0), v(e.axes, function (a) {
		...
		y.prototype = {
			...
			cloneRenderTo: function (a) {
				...
				if (a) {
					...
					c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), f(b, {
						position: "absolute",
						top: "-9999px",
						display: "block"
			...
			reflow: function (a) {
				...
				if (!m && !c.isPrinting && h && f && (d ===
					...
					if (h !== c.containerWidth || f !== c.containerHeight)
						clearTimeout(c.reflowTimeout), c.reflowTimeout = z(function () {
		...
		E.prototype = {
			...
			optionsToObject: function (a) {
				...
				if (v(a) || null === a)
					...
					for (!d && a.length > k && (f = typeof a[0], "string" === f ? b.name = a[0] : "number" === f && (b.x = a[0]), e++); h < k; )
						d && void 0 === a[e] || (b[l[h]] =
								a[e]), e++, h++;
				else
					"object" === typeof a && (b = a, a.dataLabels && (f._hasPointLabels = !0), a.marker && (f._hasPointMarkers = !0));
				return b
			},
		...
		a.Series = a.seriesType("line", null, {
				...
				bindAxes: function () {
					...
					r(a.axisTypes || [], function (d) {
						r(e[d], function (b) {
							f = b.options;
							if (c[d] === f.index || void 0 !== c[d] && c[d] === f.id || void 0 === c[d] && 0 === f.index)
				...
				setData: function (a, c, f, d) {
					...
					q = a.length;
					c = u(c, !0);
					if (!1 !== d && q && n === q && !m.cropped && !m.hasGroupedData && m.visible)
						r(a, function (a, b) {
						...
						if (x && q > x) {
							...
							if (e(D))
								for (f = 0; f < q; f++)
									G[f] = this.autoIncrement(), w[f] = a[f];
							else if (k(D))
								if (v)
									for (f = 0; f < q; f++)
										D = a[f], G[f] = D[0], w[f] = D.slice(1, v + 1);
								else
									for (f = 0; f < q; f++)
										D = a[f], G[f] =
											D[0], w[f] = D[1];
				...
				processData: function (a) {
					...
					r,
					D;
					if (u && !this.isDirty && !g.isDirty && !this.yAxis.isDirty && !a)
						return !1;
					...
					if (u && this.sorted && !l && (!q || f > q || this.forceCrop))
						if (c[f - 1] < r || c[0] > D)
							...
							d = this.cropData(this.xData, this.yData, r, D), c = d.xData, e = d.yData, d = d.start, h = !0;
					for (q = c.length || 1; --q; )
						f = t ? n(c[q]) - n(c[q - 1]) : c[q] - c[q -
				...
				generatePoints: function () {
					...
					for (t = 0; t < h; t++)
						k = g + t, n ? (l = (new d).init(this, [e[t]].concat(q(f[t]))), l.dataGroup = this.groupMap[t]) : (l = b[k]) || void 0 === a[k] || (b[k] = l = (new d).init(this, a[k], e[t])), l.index = k, u[t] = l;
					if (b && (h !== (c = b.length) || n))
						for (t = 0; t < c; t++)
							t !== g || n || (t += h), b[t] && (b[t].destroyElements(), b[t].plotX = void 0);
					this.data = b;
					this.points = u
				},
				...
				drawPoints: function () {
					...
					if (!1 !== g.enabled || this._hasPointMarkers)
						for (f = a.length; f--; )
							d = a[f], c = d.plotY, h = d.graphic, k = d.marker || {},
					n = !!d.marker,
					q = r && void 0 === k.enabled || k.enabled,
					l = d.isInside,
					q && e(c) && null !== d.y ? (c = u(k.symbol, this.symbol), d.hasImage = 0 === c.indexOf("url"), q = this.markerAttribs(d, d.selected && "select"), h ? h[l ? "show" : "hide"](!0).animate(q) : l && (0 < q.width || d.hasImage) && (d.graphic = h = b.renderer.symbol(c, q.x, q.y, q.width, q.height, n ? k : g).add(t)), h && h.attr(this.pointAttribs(d,
				...
				destroy: function () {
					...
					for (g in a)
						a[g]instanceof K && !a[g].survive && (d = e && "group" === g ? "hide" : "destroy", a[g][d]());
				...
				buildKDTree: function () {
					function a(c, e, f) {
						...
						h;
						if (h = c && c.length)
							return d = b.kdAxisArray[e % f], c.sort(function (a, b) {
								return a[d] - b[d]
							}), h = Math.floor(h / 2), {
								point: c[h],
	...
	(function (a) {
		...
		E.prototype = {
			...
			setOffset: function (a, f) {
				...
				if (f = this.label)
					f.align(this.alignOptions, null, g), g = f.alignAttr, f[!1 === this.options.crop || d.isInsidePlot(g.x, g.y) ? "show" : "hide"](!0)
			}
		};
		...
		A.prototype.buildStacks = function () {
			...
			if (!this.isXAxis) {
				...
				for (g = d; g--; )
					a[b ? g : d - g - 1].setStackedPoints();
				for (g = d; g--; )
					f = a[b ? g : d - g - 1], f.setStackCliffs &&
					f.setStackCliffs();
		...
		A.prototype.resetStacks = function () {
			...
			if (!this.isXAxis)
				for (f in a)
					for (b in a[f])
						a[f][b].touched < this.stacksTouched ? (a[f][b].destroy(),
			...
			g([f, "-" + f], function (f) {
				for (var g = d.length, e, h; g--; )
					if (e = d[g], l = a.getStackIndicator(l,
								e, a.index, f), e = (h = b[f] && b[f][e]) && h.points[l.key])
						h = h.total ? 100 / h.total : 0, e[0] = H(e[0] * h), e[1] = H(e[1] * h), a.stackedYData[g] = e[1]
			})
		};
	...
	(function (a) {
		...
		l(a.Chart.prototype, {
			...
			update: function (a, e) {
				...
				if (k) {
					...
					for (c in k)
						k.hasOwnProperty(c) && (-1 !== f("chart." + c, this.propsRequireUpdateSeries) && (q = !0), -1 !== f(c, this.propsRequireDirtyBox) && (this.isDirtyBox =
									!0));
				...
				for (c in a) {
					if (this[c] && "function" === typeof this[c].update)
						this[c].update(a[c], !1);
					else if ("function" === typeof this[h[c]])
						this[h[c]](a[c]);
		...
		l(F.prototype, {
			...
			remove: function (a) {
				for (var b = this.chart, c = this.coll, e = this.series, f = e.length; f--; )
					e[f] && e[f].remove(!1);
				v(b.axes, this);
				v(b[c], this);
		...
		d("area", "line", {
			...
			getStackPoints: function () {
				...
				if (this.options.stacking) {
					...
					A(d, function (c, g) {
						...
						u;
						if (b[c] && !b[c].isNull)
							a.push(b[c]), A([-1, 1], function (a) {
								var n = 1 === a ? "rightNull" : "leftNull",
								l = 0,
								t = f[d[g + a]];
								if (t)
									for (C = w; 0 <= C && C < k; )
										q = t.points[C], q || (C === w ? b[c][n] = !0 : e[C] && (u = f[c].points[C]) && (l -= u[1] - u[0])), C += h;
			...
			getGraphPath: function (a) {
				...
				for (b = 0; b < a.length; b++)
					if (n = a[b].isNull, e = H(a[b].rectPlotX, a[b].plotX), c = H(a[b].yBottom, u), !n || g)
						g || q(b, b - 1, "left"), n && !r && g || (t.push(a[b]), w.push({
								x: b,
								plotX: e,
								plotY: c
							})), g || q(b, b + 1, "right");
			...
			drawGraph: function () {
				...
				d = this.areaPath,
				l = this.options,
				r = [["area", "highcharts-area", this.color, l.fillColor]];
			...
			translate: function () {
				...
				F(a.points, function (d) {
					...
					d.tooltipPos = b.inverted ? [t.len + t.pos - b.plotLeft -
							h, a.xAxis.len - n - l / 2, v] : [n + l / 2, h + t.pos - b.plotTop, v];
					d.shapeType = "rect";
				...
				F(a.points, function (e) {
					...
					if (p(e.plotY) && null !== e.y) {
						...
						if (f)
							...
							e.graphic = f = l[e.shapeType](k).attr({
	...
	(function (a) {
		...
		a.CenteredSeriesMixin = {
			getCenter: function () {
				...
				r;
				for (l = 0; 4 > l; ++l)
					r = g[l], a = 2 > l || 2 === l && /%$/.test(r), g[l] = A(r, [d, H, v, g[2]][l]) + (a ? p : 0);
				g[3] > g[2] && (g[3] = g[2]);
				return g
			}
		}
	...
	(function (a) {
		...
		r("pie", "line", {
			...
			updateTotals: function () {
				...
				for (a = 0; a < g; a++)
					k = f[a], 0 > k.y && (k.y = null), d += e && !k.visible ? 0 : k.y;
				this.total = d;
				for (a = 0; a < g; a++)
					k = f[a], k.percentage = 0 < d && (k.visible || !e) ? k.y / d * 100 : 0, k.total = d
			},
			generatePoints: function () {
	...
	(function (a) {
		...
		a.distribute = function (a, b) {
			...
			for (a = g(a, function (a) {
				...
				d = a.length;
				for (f = !1; d--; )
					0 < d && a[d - 1].pos + a[d - 1].size > a[d].pos && (a[d - 1].size += a[d].size, a[d - 1].targets = a[d - 1].targets.concat(a[d].targets), a[d - 1].pos + a[d - 1].size > b && (a[d - 1].pos = b - a[d - 1].size), a.splice(d, 1), f = !0)
			}
			d = 0;
			H(a, function (a) {
				var b = 0;
		...
		b.prototype.drawDataLabels = function () {
			...
			if (e.enabled || a._hasPointLabels)
				a.dlProcessOptions && a.dlProcessOptions(e), n = a.plotGroup("dataLabelsGroup", "data-labels", w && !c ? "hidden" : "visible", e.zIndex || 6), w && (n.attr({
						opacity: +c
			...
			d.visible && (l.enabled || d._hasPointLabels) && (b.prototype.drawDataLabels.apply(d), H(f, function (a) {
					...
					if (u)
						for (d.sortByAngle(b, c - .5), 0 < w && (f = Math.max(0, G - D - w), k = Math.min(G + D + w, h.plotHeight), r = g(b, function (a) {
									...
									}), a.distribute(r, k + v - f)), R = 0; R < u; R++)
							e = b[R], z = e.labelPos, N = e.dataLabel, Q = !1 === e.visible ? "hidden" : "inherit", t = z[1], r ? void 0 === r[R].pos ? Q = "hidden" : (O = r[R].size, B = f + r[R].pos) : B = t, y = l.justify ? E[0] + (c ? -1 : 1) * (D + w) : d.getX(B < f + 2 || B > k - 2 ? t : B, c), N._attr = {
								visibility: Q,
								align: z[6]
							},
					N._pos = {
					...
					z.x = y,
					z.y = B,
					null === d.options.size && (m = N.width, y - m < n ? S[3] = Math.max(Math.round(m - y + n), S[3]) : y + m > q - n &&
					...
					if ((N = a.dataLabel) && N._pos && a.visible) {
						...
						if (b = !v)
							a.connector = v = h.renderer.path().addClass("highcharts-data-label-connector highcharts-color-" + a.colorIndex).add(d.dataLabelsGroup), v.attr({
								"stroke-width": c,
	...
	(function (a) {
		...
		E.prototype.hideOverlappingLabels = function (a) {
			...
			for (p = 0; p < d; p++)
				if (g = a[p])
					g.oldOpacity = g.opacity, g.newOpacity = 1;
			a.sort(function (a, b) {
			...
			for (p = 0; p < d; p++)
				for (l = a[p], g = p + 1; g < d; ++g)
					if (r = a[g], l && r && l.placed && r.placed && 0 !==
						l.newOpacity && 0 !== r.newOpacity && (f = l.alignAttr, b = r.alignAttr, n = l.parentGroup, w = r.parentGroup, t = 2 * (l.box ? 0 : l.padding), f = k(f.x + n.translateX, f.y + n.translateY, l.width - t, l.height - t, b.x + w.translateX, b.y + w.translateY, r.width - t, r.height - t)))
	...
	(function (a) {
		...
		a = a.TrackerMixin = {
			...
			drawTrackerGraph: function () {
				...
				if (f && !d)
					for (t = f + 1; t--; )
						"M" === e[t] && e.splice(t + 1, 0, e[t + 1] - n, e[t + 2], "L"), (t && "M" === e[t] || t === f) && e.splice(t, 0, "L", e[t - 2] + n, e[t - 1]);
				p ? p.attr({
					d: e
		...
		v(k.prototype, {
			...
			setState: function (a, b) {
				...
				if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (n || k && !1 === l.enabled) || a && m.states &&
					...
					if (this.graphic)
						this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.attr(f.pointAttribs(this, a)), w && this.graphic.animate(w, t(r.options.chart.animation, l.animation, h.animation)), p && p.hide();
					else {
						if (a && l) {
							h = m.symbol || f.symbol;
							...
							if (p)
								...
								h && (f.stateMarkerGraphic = p = r.renderer.symbol(h,
			...
			function g(a, f, b) {
				...
				for (l in a)
					if (-1 < F(l, ["series", "xAxis", "yAxis"]))
						for (a[l] = d(a[l]), b[l] = [], p = 0; p < a[l].length; p++)
							b[l][p] = {},
				g(a[l][p], f[l][p], b[l][p]);
				else
					H(a[l]) ? (b[l] = {}, g(a[l], f[l] || {}, b[l])) : b[l] = f[l] || null
			}
			var l = {};
			g(a, this.options, l);
			return l
